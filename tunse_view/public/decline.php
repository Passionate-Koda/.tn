             ...
             <div class="content">
                 ...
                 <div class="content-control">
                     ...
                     <ul class="breadcrumb">
                       ...
                       <li class="active">Task Declined</li>
                     </ul>
                     </div>
                     <!--/breadcrumb--
                 <!-- /content-control -->
                 ...
                 <div class="content-body">
                   <div class="callout callout-success">
                      <h3><p>Your task was Declined by <?php echo $uname ?>, Below are the information</p><h3>
                                    ...
                                    <div class="modal-content bg-darknight">
                                        <div class="modal-body text-white">
                                          <div class="" style="text-align: center">
                                            ...
                                            <p><img style=" margin-left: auto;margin-right: auto;text-align: center;display: table-cell;vertical-align: middle;max-height: 350px;max-width: 350px;" src="<?php echo $tworkers_image ?>" style="height: 100px; border-radius:20% ; width: 150px" class="img-responsive" alt="Fountain" class="img-rounded img-responsive"></p>
                                            <hr>
                                            <h1>Task Details</h1>
                                            ...
                                            <p><strong>Time:</strong> <?php echo $formattedTime ?></p>
                                             ...
                                             <div class="clearfix">
                                                 <div class="pull-right">
                                                   <span>You can Send Task to another Tworker</span>
                                                   <button onclick="redirect('tunsehome')"  id="msg" type="button" class="btn btn-primary" data-dismiss="modal">Here</button>
                                                 </div>
                                             </div>
