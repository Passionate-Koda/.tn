<div class="content-header">
    <div class="content-header-extra">
        <a class="item-ch-extra" href="#">
            ...
            <div class="data-text text-success">
              <strong id="taskNot2">--</strong><p class="text-muted">Accepted Task</p>
            </div>
        </a><!--/item-ch-extra-->
        ...
        <a class="item-ch-extra" href="#">
            ...
            <div class="data-text text-primary">
              <strong id="ptaskNot2">--</strong><p class="text-muted">Pending Tasks</p>
            </div>
        </a><!--/item-ch-extra-->
    ...
    <h2 class="content-title"><i class="fa fa-home"></i>DASHBOARD</h2>
</div><!--/content-header -->
